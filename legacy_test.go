...
func TestLegostashHook(t *testing.T) {
	...
	tt := []struct {
		expected Expct
		initFunc func() (*LegacyHook, error)
	}{
		{Expct{"bla", "", nil}, func() (*LegacyHook, error) {
			return NewHook("udp", "localhost:9999", "bla")
		}},
		{Expct{"bzz", "", nil}, func() (*LegacyHook, error) {
		...
		{Expct{"blk", "", logrus.Fields{"id": 1}}, func() (*LegacyHook, error) {
			return NewHookWithFields("udp", "localhost:9999", "blk", logrus.Fields{"id": 1})
		}},
		{Expct{"prefix", "-->", logrus.Fields{"id": 1}}, func() (*LegacyHook, error) {
			return NewHookWithFieldsAndPrefix("udp", "localhost:9999", "prefix", logrus.Fields{"id": 1}, "-->")
		}},
		{Expct{"fieldsconn", "", logrus.Fields{"id": 5}}, func() (*LegacyHook, error) {
			udpConn, err := net.Dial("udp", "localhost:9999")
			if err != nil {
				return nil, err
			}
		...
		{Expct{"zz", "~~>", logrus.Fields{"id": "bal"}}, func() (*LegacyHook, error) {
			udpConn, err := net.Dial("udp", "localhost:9999")
			if err != nil {
				return nil, err
			}
...
func TestNewFiltering(t *testing.T) {
	...
	tt := []struct {
		expected Expct
		initFunc func() *LegacyHook
	}{
		{Expct{"", ""}, func() *LegacyHook {
...
func TestSettingAttributes(t *testing.T) {
	tt := []struct {
		setFunc   func(*LegacyHook)
		expctFunc func(*LegacyHook) error
	}{
		{func(h *LegacyHook) {
			h.WithPrefix("mprefix1")
		}, func(h *LegacyHook) error {
